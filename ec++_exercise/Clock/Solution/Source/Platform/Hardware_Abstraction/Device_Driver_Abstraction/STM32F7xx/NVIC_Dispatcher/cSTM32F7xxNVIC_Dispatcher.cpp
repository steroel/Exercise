	...
	namespace Hardware_Abstraction
	{
		namespace Device_Driver_Abstraction
		{
			namespace STM32F7xx
			{
				...
				{
					icbcInterruptDispatcher*  cSTM32F7xxNVIC_Dispatcher::mptrCallbackObject[InterruptVectorNumberAmount];
					icbcInterruptAcknowledge* cSTM32F7xxNVIC_Dispatcher::mptrAcknowledgeObject[InterruptVectorNumberAmount];
					...
					void cSTM32F7xxNVIC_Dispatcher::registerInterruptCallback(icbcInterruptDispatcher* const ptrInterruptCallbackObject, const InterruptVectorNumber_t InterruptVectorNumber)
					{
					...
					void cSTM32F7xxNVIC_Dispatcher::registerInterruptAcknowledge(icbcInterruptAcknowledge* const ptrInterruptAcknowledgeObject, const InterruptVectorNumber_t InterruptVectorNumber)
					{
