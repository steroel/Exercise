#ifndef __cSTM32F1xxNVIC_Driver_HPP__
#define __cSTM32F1xxNVIC_Driver_HPP__
			...
			namespace STM32F1xx
			{
				namespace NVIC_Dispatcher
				{
					...
					class cSTM32F1xxNVIC_Driver
					{
						...
						private:
							static cSTM32F1xxNVIC_Register* const volatile mptrRegisterBaseAddress;	
					};
				}
			}
		}
...
#endif // __cSTM32F1xxNVIC_Driver_HPP__
