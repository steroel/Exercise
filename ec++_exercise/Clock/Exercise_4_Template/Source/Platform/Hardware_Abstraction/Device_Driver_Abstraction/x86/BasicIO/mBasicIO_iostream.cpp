...
namespace Plattform
{
	namespace HAL
	{
		...
		//{
			//namespace BasicIO
			//{
				void showValue(const char* ptrText, int8_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, int16_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, int32_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, int64_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, uint8_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, uint16_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, uint32_t Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, uint64_t Number)
				{
					//cout << ptrText << hex << number << " ";
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, double Number)
				{
					cout << ptrText << Number << " ";
				}

				void showValue(const char* ptrText, bool Evaluation)
				{
					if (Evaluation == true)
					{
						cout << ptrText << " ";
				...
				void showValue(const char* ptrText, double Number, const char* ptrText1)
				{
					cout << ptrText << Number << ptrText1;
				}
