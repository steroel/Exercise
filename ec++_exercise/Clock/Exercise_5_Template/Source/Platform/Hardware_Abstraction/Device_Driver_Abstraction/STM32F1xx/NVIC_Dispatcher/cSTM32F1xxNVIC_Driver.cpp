#include "cSTM32F1xxNVIC_Driver.hpp"
	...
	namespace Hardware_Abstraction
	{
		namespace Device_Driver_Abstraction
		{
			namespace STM32F1xx
			{
				...
				{
					//cSTM32F1xxNVIC_Register* const volatile cSTM32F1xxNVIC_Driver::mptrRegisterBaseAddress = (cSTM32F1xxNVIC_Register* volatile const)NVIC_BASE;
					cSTM32F1xxNVIC_Register* const volatile cSTM32F1xxNVIC_Driver::mptrRegisterBaseAddress = reinterpret_cast<cSTM32F1xxNVIC_Register* volatile const>(NVIC_BASE);					

					void cSTM32F1xxNVIC_Driver::enableIRQ(const InterruptVectorNumber_t InterruptVectorNumber)
					{
					...
					void cSTM32F1xxNVIC_Driver::disableIRQ(const InterruptVectorNumber_t InterruptVectorNumber)
					{
						const uint32_t locRegisterIndex       = (InterruptVectorNumber / 32);
						const uint32_t locRegisterBitPosition = (InterruptVectorNumber % 32);
					...
					void cSTM32F1xxNVIC_Driver::setPendingIRQ(const InterruptVectorNumber_t InterruptVectorNumber)
					{
						const uint32_t locRegisterIndex       = (InterruptVectorNumber / 32);
						const uint32_t locRegisterBitPosition = (InterruptVectorNumber % 32);
					...
					void cSTM32F1xxNVIC_Driver::clearPendingIRQ(const InterruptVectorNumber_t InterruptVectorNumber)
					{
						const uint32_t locRegisterIndex       = (InterruptVectorNumber / 32);
						const uint32_t locRegisterBitPosition = (InterruptVectorNumber % 32);
					...
					uint32_t cSTM32F1xxNVIC_Driver::getPendingIRQ(const InterruptVectorNumber_t InterruptVectorNumber)
					{
						const uint32_t locRegisterIndex       = (InterruptVectorNumber / 32);
						const uint32_t locRegisterBitPosition = (InterruptVectorNumber % 32);
					...
					void cSTM32F1xxNVIC_Driver::setPriority(const InterruptVectorNumber_t InterruptVectorNumber, const InterruptPriority_t InterruptPriority)
					{
					...
					InterruptPriority_t cSTM32F1xxNVIC_Driver::getPriority(const InterruptVectorNumber_t InterruptVectorNumber)
					{
