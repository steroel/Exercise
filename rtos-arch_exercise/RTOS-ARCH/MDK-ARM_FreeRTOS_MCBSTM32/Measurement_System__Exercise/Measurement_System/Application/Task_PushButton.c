...
//	if (... == pdTRUE)	// request the display as resource
//	{																														// successful
		LCD_printStringXY(15, 0, "_");														// access display resource
//		if (... != pdTRUE)							// release display resource
//		{
...
//	if (... == pdTRUE)	// request the display resource
//	{																														// successful
