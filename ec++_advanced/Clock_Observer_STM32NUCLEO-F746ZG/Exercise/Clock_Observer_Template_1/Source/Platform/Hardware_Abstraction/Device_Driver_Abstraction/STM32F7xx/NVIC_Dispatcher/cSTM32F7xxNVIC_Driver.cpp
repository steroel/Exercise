		...
		namespace Device_Driver_Abstraction
		{
			namespace STM32F7xx
			{
				namespace NVIC_Dispatcher
				{
					...
					void cSTM32F7xxNVIC_Driver::setPriority(const InterruptVectorNumber_t InterruptVectorNumber, const InterruptPriority_t Priority)
					{
						mptrRegisterBaseAddress->setNVIC_IP(Priority << 4, InterruptVectorNumber);  // this CPU only supports a priority range from 0 to 15,
