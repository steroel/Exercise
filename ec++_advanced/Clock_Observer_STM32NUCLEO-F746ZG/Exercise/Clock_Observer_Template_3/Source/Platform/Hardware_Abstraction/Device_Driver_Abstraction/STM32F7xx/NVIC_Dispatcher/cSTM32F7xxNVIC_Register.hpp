		...
		namespace Device_Driver_Abstraction
		{
			namespace STM32F7xx
			{
				namespace NVIC_Dispatcher
				{
					...
					{
						public:
							void setNVIC_ISER(const vuint32_t NVIC_ISER_RegisterValue, const uint32_t RegisterIndex);
							void setNVIC_ICER(const vuint32_t NVIC_ICER_RegisterValue, const uint32_t RegisterIndex);
							void setNVIC_ISPR(const vuint32_t NVIC_ISPR_RegisterValue, const uint32_t RegisterIndex);
							void setNVIC_ICPR(const vuint32_t NVIC_ICPR_RegisterValue, const uint32_t RegisterIndex);
							void setNVIC_IABR(const vuint32_t NVIC_IABR_RegisterValue, const uint32_t RegisterIndex);
							void setNVIC_IP(const vuint8_t NVIC_IP_RegisterValue, const uint32_t RegisterIndex);
						...
						private:
							...
							vuint8_t NVIC_IP[240]; // registers are byta accessible
